...
length = Label(root, text="Select the Length of Your Password :- ", fg="black", bg="beige", font=("ubuntu", 12))
...
generate_btn = Button(root, text="GENERATE PASSWORD", bg="orange", fg="beige", font=("ubuntu", 15), cursor="hand2", command=PASSWORD_GENERATOR)
generate_btn.bind("<Enter>", on_enter)
generate_btn.bind("<Leave>", on_leave)
generate_btn.pack(anchor="center", pady="50px")

result_lable = Label(root, text="Generated password Here:- ", bg="beige", fg="black", font=("ubuntu", 12))
